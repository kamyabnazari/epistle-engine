		...
		<div>
			<div class="my-20 max-w-md">
				...
				<p class="py-6 text-justify text-base">
					We believe in the power of open communication, and your input is incredibly valuable to
					us. If you have any queries, suggestions, or feedback about our application and ChatGPT
					plugin, we would love to hear from you.
				</p>
				...
				<p class="py-6 text-justify text-base">
					We look forward to hearing your ideas and working together to continue revolutionizing the
					way we interact with documents.
				</p>
				<p class="py-6 text-justify text-base">
